...
export declare type MenuOption = Option & {
  visible: boolean;
};
...
export declare type PickMenuProps<T> = {
...
export declare type PickValueProps<T> = {
  [P in keyof T as Exclude<
    P,
    'enableSearch' | 'virtualize' | 'onSelected' | 'maxMenuHeight' | 'options'
  >]: T[P];
};
export declare type DropdownMenuProps = PickMenuProps<DropdownProps> &
  OverlayModel<null> & {
...
export declare type DropdownValueProps = PickValueProps<DropdownProps> & {

...
const Widget: React.FunctionComponent = () => {
  ...
  return (
    <div className="rc-demo-widgets">
      <Section size="md" title="Docked Right" height={100}>
      ...
      <Section size="md" title="Docked Left" height={100}>
      ...
      <Section size="md" title="Docked Top" height={100}>
      ...
      <Section size="md" title="Docked Bottom" height={100}>

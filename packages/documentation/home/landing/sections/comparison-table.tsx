...
const ComparisonTable: FunctionComponent = () => {
  ...
  const renderCell = (
    ...
    return (
      <span
        className={cx(styles.text_value, isHighlight && styles.highlight_text)}
      >
        {value}
      </span>
    );
  ...
  return (
    <section
      className={cx(styles.comparison_section, isDarkMode ? styles.dark : '')}
    >
          ...
          <table className={styles.comparison_table}>
            <thead>
              <tr>
                ...
                <th
                  className={cx(styles.library_header, styles.highlight_column)}
                >
